...
std::string CBlock::getHashStr()                        // hex format of hash
{
...
bool CBlock::isDifficulty(int difficulty)               // check if mining difficulty has reached target difficulty
{
